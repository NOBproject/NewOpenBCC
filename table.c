...
{
    { "sub", TRUE, 0, 0, &vtype, },	/* first - addkeyword uses vtype */
    { "byte", TRUE, CHAR, 1, &ctype, },
    { "byte", FALSE, UNSIGNED | CHAR, 1, &uctype, },
    { "byte", FALSE, CHAR, 1, &sctype, },
    { "short", TRUE, SHORT, 2, &stype, },
    { "short", FALSE, UNSIGNED | SHORT, 2, &ustype, },
    { "number", TRUE, INT, 2, &itype, },
    { "number", FALSE, UNSIGNED | INT, 2, &uitype, },
